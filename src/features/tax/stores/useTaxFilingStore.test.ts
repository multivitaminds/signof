...
vi.mock('../lib/api', () => ({
  ...
  createFormW2Service: vi.fn(() => mockFormServiceFactory()),
  createForm1099NecService: vi.fn(() => mockFormServiceFactory()),
  createForm1099MiscService: vi.fn(() => mockFormServiceFactory()),
  createForm1099IntService: vi.fn(() => mockFormServiceFactory()),
  createForm1099DivService: vi.fn(() => mockFormServiceFactory()),
  createForm1099RService: vi.fn(() => mockFormServiceFactory()),
  createForm1099KService: vi.fn(() => mockFormServiceFactory()),
  createForm1098Service: vi.fn(() => mockFormServiceFactory()),
  createForm1098EService: vi.fn(() => mockFormServiceFactory()),
  createForm1098TService: vi.fn(() => mockFormServiceFactory()),
  createForm941Service: vi.fn(() => mockFormServiceFactory()),
  createForm940Service: vi.fn(() => mockFormServiceFactory()),
  createForm1095cService: vi.fn(() => mockFormServiceFactory()),
  buildFormW2Payload: vi.fn((data: unknown) => data),
  buildForm1099NecPayload: vi.fn((data: unknown) => data),
  buildForm1099MiscPayload: vi.fn((data: unknown) => data),
  buildForm1099IntPayload: vi.fn((data: unknown) => data),
  buildForm1099DivPayload: vi.fn((data: unknown) => data),
  buildForm1099RPayload: vi.fn((data: unknown) => data),
  buildForm1099KPayload: vi.fn((data: unknown) => data),
  buildForm1098Payload: vi.fn((data: unknown) => data),
  buildForm1098EPayload: vi.fn((data: unknown) => data),
  buildForm1098TPayload: vi.fn((data: unknown) => data),
  FormService: {},
}))
...
vi.mock('../lib/extractionToPayload', () => ({
  ...
  extractionTo1099MiscRecipient: vi.fn(() => ({
    tin: '123456789',
    name: 'Jane Doe',
    address1: '100 Main St',
    city: 'Springfield',
  ...
  extractionTo1099IntRecipient: vi.fn(() => ({
    tin: '123456789',
    name: 'Jane Doe',
    address1: '100 Main St',
    city: 'Springfield',
  ...
  extractionTo1099DivRecipient: vi.fn(() => ({
    tin: '123456789',
    name: 'Jane Doe',
    address1: '100 Main St',
    city: 'Springfield',
  ...
  extractionTo1099RRecipient: vi.fn(() => ({
    tin: '123456789',
    name: 'Jane Doe',
    address1: '100 Main St',
    city: 'Springfield',
  ...
  extractionTo1099KRecipient: vi.fn(() => ({
    tin: '123456789',
    name: 'Jane Doe',
    address1: '100 Main St',
    city: 'Springfield',
  ...
  extractionTo1098Recipient: vi.fn(() => ({
    tin: '123456789',
    name: 'Jane Doe',
    address1: '100 Main St',
    city: 'Springfield',
