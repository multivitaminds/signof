...
const BASE_URL = 'https://api.origina.io'
...
const ENDPOINTS: ApiEndpoint[] = [
  ...
  -H "Authorization: Bearer sk_live_..."`,
    jsExample: `import OriginA from '@origina/node';

const origina = new OriginA('sk_live_...');

const documents = await origina.documents.list({
  status: 'pending',
  limit: 10,
});

console.log(documents.data);`,
    pythonExample: `import origina
...
print(documents.data)`,
  ...
  -d '{
    ...
    jsExample: `const doc = await origina.documents.create({
  name: 'Employment Agreement',
  file_url: 'https://files.example.com/agreement.pdf',
  signers: [
...
print(doc.id)`,
  ...
  "file_url": "https://files.origina.io/doc_abc123.pdf",
  "signers": [
    {
      "id": "sig_1",
      "name": "John Doe",
  ...
  -H "Authorization: Bearer sk_live_..."`,
    jsExample: `const doc = await origina.documents.retrieve('doc_abc123');
...
print(doc.signers)`,
  ...
  -d '{ "name": "Updated Contract Name" }'`,
    jsExample: `const doc = await origina.documents.update('doc_abc123', {
  name: 'Updated Contract Name',
});
...
print(doc.name)`,
  ...
  -H "Authorization: Bearer sk_live_..."`,
    jsExample: `await origina.documents.delete('doc_abc123');`,
  ...
  "signers": [
    {
      ...
      "email": "john@example.com",
      "status": "pending",
      "signing_url": "https://sign.origina.io/s/abc123"
    }
  ]
}`,
  ...
  -d '{ "message": "Please review and sign.", "subject": "Document Ready" }'`,
    jsExample: `const result = await origina.documents.send('doc_abc123', {
...
print(result.signers[0].signing_url)`,
  ...
  -d '{ "name": "Alice Johnson", "email": "alice@example.com", "order": 2 }'`,
    jsExample: `const signer = await origina.documents.signers.create('doc_abc123', {
  name: 'Alice Johnson',
  email: 'alice@example.com',
  order: 2,
});
...
print(signer.id)`,
  ...
  -H "Authorization: Bearer sk_live_..."`,
    jsExample: `const signers = await origina.documents.signers.list('doc_abc123');
...
for signer in signers.data:
  ...
  "data": [
    {
      ...
      "status": "confirmed",
      "location": "https://meet.origina.io/bk_001"
    }
  ],
  "has_more": false,
  "total": 1
  ...
  -H "Authorization: Bearer sk_live_..."`,
    jsExample: `const bookings = await origina.bookings.list({
  status: 'confirmed',
});
...
print(bookings.data)`,
  ...
  "status": "confirmed",
  "location": "https://meet.origina.io/bk_new002",
  ...
  -d '{
    ...
    jsExample: `const booking = await origina.bookings.create({
  event_type: 'consultation',
  invitee: { name: 'Sarah Lee', email: 'sarah@example.com' },
  start_time: '2025-12-30T10:00:00Z',
  timezone: 'America/New_York',
...
print(booking.location)`,
  ...
  -H "Authorization: Bearer sk_live_..."`,
    jsExample: `const databases = await origina.databases.list();
...
print(databases.data)`,
  ...
  -d '{
    ...
    jsExample: `const record = await origina.databases.records.create('db_001', {
  fields: {
    Name: 'New Contact',
    Email: 'contact@example.com',
    Status: 'Active',
    ...
    <div className="api-docs-page">
      <div className="api-docs-page__header">
        ...
        <p className="api-docs-page__subtitle">
          Complete reference for the OriginA REST API. All endpoints require authentication
