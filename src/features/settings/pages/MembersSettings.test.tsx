...
const sampleTeam: Team = {
  ...
  name: 'Test Workspace',
  members: [
    { id: 'member-1', name: 'Alex Johnson', email: 'alex@signof.com', role: TeamRole.Owner, joinedAt: '2024-01-15T00:00:00Z', lastActiveAt: '2025-01-10T09:30:00Z', status: MemberStatus.Active },
    { id: 'member-2', name: 'Sarah Chen', email: 'sarah@signof.com', role: TeamRole.Admin, joinedAt: '2024-02-20T00:00:00Z', lastActiveAt: '2025-01-09T14:22:00Z', status: MemberStatus.Active },
    { id: 'member-3', name: 'Mike Rivera', email: 'mike@signof.com', role: TeamRole.Member, joinedAt: '2024-03-10T00:00:00Z', lastActiveAt: '2025-01-08T11:45:00Z', status: MemberStatus.Active },
    { id: 'member-4', name: 'Emma Davis', email: 'emma@signof.com', role: TeamRole.Member, joinedAt: '2024-04-05T00:00:00Z', lastActiveAt: '2025-01-07T16:10:00Z', status: MemberStatus.Deactivated },
  ],
  invites: [
