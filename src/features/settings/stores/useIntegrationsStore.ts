...
const DEFAULT_INTEGRATIONS: IntegrationConfig[] = [
  ...
  },
  {
    ...
    name: 'GitHub',
    icon: '\uD83D\uDC19',
    description: 'Link issues and pull requests to your SignOf projects.',
    connected: false,
    connectedAt: null,
  },
  {
  ...
  },
  {
    ...
    name: 'Zapier',
    icon: '\u26A1',
    description: 'Automate workflows by connecting SignOf with 5,000+ apps.',
    connected: false,
    connectedAt: null,
  },
  {
...
export const useIntegrationsStore = create<IntegrationsState>()(
  persist(
    ...
    { name: 'signof-integrations-storage' }
  )
)
